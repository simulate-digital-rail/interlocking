...
def test_reset():
    ...
    helper.test_signal(interlocking, "60BS1", "go")
    ...
    helper.test_signal(interlocking, "60ES2", "go")
    ...
    helper.test_track(interlocking, "a8f44-0", "RB101", OccupancyState.FREE)
    helper.test_signal(interlocking, "60BS1", "halt")
    ...
    helper.test_signal(interlocking, "60ES2", "halt")
...
def test_driving():
    ...
    helper.test_track(interlocking, "b8e69-1", "RB101", OccupancyState.RESERVED_OVERLAP)
    helper.test_track(interlocking, "b8e69-2", "RB101", OccupancyState.RESERVED_OVERLAP)
    helper.test_track(interlocking, "b8e69-3", "RB101", OccupancyState.RESERVED_OVERLAP)
    helper.test_track(interlocking, "a8f44-0", "RB101", OccupancyState.FREE)
    helper.test_signal(interlocking, "60BS1", "go")

    route_2 = helper.get_route_by_signal_names(topology, "60BS2", "60BS3")
    asyncio.run(helper.set_route(interlocking, route_2, True, "RB101"))

    helper.test_point(interlocking, "d43f9", "RB101", "left", OccupancyState.RESERVED)
    helper.test_point(interlocking, "fb749", "RB101", "right", OccupancyState.RESERVED)
    ...
    helper.test_track(interlocking, "94742-0", "RB101", OccupancyState.OCCUPIED)
    ...
    helper.free_route(interlocking, route_1, "RB101")
    ...
    helper.free_route(interlocking, route_2, "RB101")
...
def test_reset_route():
    ...
    helper.test_track(interlocking, "a8f44-0", "RB101", OccupancyState.FREE)
    helper.test_signal(interlocking, "60BS1", "halt")
    helper.test_point(interlocking, "d43f9", "RB101", "left", OccupancyState.FREE)
...
def test_not_allow_route_twice():
    ...
    route_1 = helper.get_route_by_signal_names(topology, "60BS1", "60BS2")
    asyncio.run(helper.set_route(interlocking, route_1, True, "RB101"))
    asyncio.run(helper.set_route(interlocking, route_1, False, "RB102"))
...
def test_not_allow_conflicting_routes():
    ...
    route_1 = helper.get_route_by_signal_names(topology, "60ES1", "60AS1")
    asyncio.run(helper.set_route(interlocking, route_1, True, "RB101"))
    route_2 = helper.get_route_by_signal_names(topology, "60ES2", "60AS3")
    asyncio.run(helper.set_route(interlocking, route_2, False, "RB102"))
...
def test_route_conflicts():
    ...
    route_es1_as1 = helper.get_route_by_signal_names(topology, "60ES1", "60AS1")
    route_es1_as2 = helper.get_route_by_signal_names(topology, "60ES1", "60AS2")
    route_es2_as3 = helper.get_route_by_signal_names(topology, "60ES2", "60AS3")
    route_es2_as4 = helper.get_route_by_signal_names(topology, "60ES2", "60AS4")
    ...
    route_bs6_bs7 = helper.get_route_by_signal_names(topology, "60BS6", "60BS7")
    route_bs1_bs2 = helper.get_route_by_signal_names(topology, "60BS1", "60BS2")
    route_bs2_bs3 = helper.get_route_by_signal_names(topology, "60BS2", "60BS3")
...
def test_failing_point():
    ...
    interlocking = helper.get_interlocking(topology, infrastructure_provider=[rwip])
    route_bs1_bs2 = helper.get_route_by_signal_names(topology, "60BS1", "60BS2")
    asyncio.run(helper.set_route(interlocking, route_bs1_bs2, False, "RB101"))
    route_bs2_bs3 = helper.get_route_by_signal_names(topology, "60BS2", "60BS3")
    asyncio.run(helper.set_route(interlocking, route_bs2_bs3, True, "RB101"))
